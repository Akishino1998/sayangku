	...
	<div id="badan">
		...
		<div id="isi">
			<table border="0" class="isipreview">
				<?php
					include('koneksi.php');
					$sql = "SELECT daftar_drama.gambar, daftar_drama.judul_drama, daftar_drama.sinopsis, daftar_drama.id_drama FROM drama_complete, daftar_drama WHERE drama_complete.id_drama=daftar_drama.id_drama ORDER BY id_drama DESC LIMIT 5 ";
